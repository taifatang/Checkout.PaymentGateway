...
namespace Checkout.PaymentGateway.Host.Middlewares
{
    //Not a requirement - Application Logging
    //copied from http://www.sulhome.com/blog/10/log-asp-net-core-request-and-response-using-middleware
    //Need to add sensitive data masking in the future and ignore certain endpoints e.g. swagger, healthcheck
